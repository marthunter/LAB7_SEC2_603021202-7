package com.example.lab7dialogrv_sec2_603021202_7
...
import com.myweb.lab7dialogrv.StudentAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    fun testStudentData() {
        studentList.add(Student("603011111-1", "Alice", 20))
        studentList.add(Student("603022222-2", "Bob", 21))
    }
}
